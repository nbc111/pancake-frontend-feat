...
export function AffiliateSunsetModal() {
  ...
  const [onOptionsConfirmModalPresent] = useModal(
    <DisclaimerModal
      ...
      bodyMaxHeight="80vh"
      modalHeader={t('Important Update: Closure of the NbcSwap Affiliate Program')}
      header={
        <>
          <Text mt="1.5rem">
            {t(`The NbcSwap Affiliate Program will officially close on %time%`, {
          ...
          <Text mt="1.5rem">
            {t('Thank you for your understanding and being a valued NbcSwap community member.')}
          </Text>
        </>
      }
