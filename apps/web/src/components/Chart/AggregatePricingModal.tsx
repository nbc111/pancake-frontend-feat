          ...
          <ContentContainer>
            <Box mb="16px">
              <Text fontSize="14px" color="text">
                {t(
                  'This chart shows aggregated price data from multiple sources. Actual output amounts for a swap request or prices from a specific NbcSwap pool may differ.',
                )}
              </Text>
            </Box>
