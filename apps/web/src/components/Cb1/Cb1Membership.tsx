    ...
    >
      <Modal title={t('You are Eligible!')} width={isMobile ? '100%' : '336px'}>
        ...
        >
          <b>Coinbase One </b>
          {t(
            'members who trade on NbcSwap on Base, BNB, or Arbitrum are eligible to earn a portion of $8,453 airdropped to their wallet biweekly! Must trade a minimum of $100 to qualify.',
          )}
        </Text>
        <Button
          style={{
