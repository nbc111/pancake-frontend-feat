  ...
  const config: Record<WalletType, MevConfig> = useMemo(
    () => ({
      ...
      [WalletType.mevOnlyManualConfig]: {
        ...
        desc: t('Your wallet requires manual setup to enable NbcSwap MEV Guard'),
      ...
      [WalletType.nativeSupportCustomRPC]: {
        ...
        desc: t('Add automatically on BNB Smart Chain: NbcSwap MEV Guard '),
        btnText: t('Add to wallet'),
      },
      [WalletType.mevNotSupported]: {
        title: t('Can’t Enable MEV Guard!'),
        desc: t('Your wallet provider doesn’t support NbcSwap MEV Guard'),
                    ...
                    {isMobile ? (
                      <FlexGap>
                        ...
                        <Box style={{ flexBasis: '60%' }}>
                          ...
                          <Text>
                            {isMEVEnabled
                              ? t('Added automatically on BNB Smart Chain: NbcSwap MEV Guard')
                              : !account
                              ? t('Add automatically on BNB Smart Chain: NbcSwap MEV Guard')
                              : mevConfig.desc}
                          </Text>
                        </Box>
                      </FlexGap>
