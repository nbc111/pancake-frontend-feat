...
const config = [
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          In the Public Sale, everyone with an active NbcSwap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active NbcSwap Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
