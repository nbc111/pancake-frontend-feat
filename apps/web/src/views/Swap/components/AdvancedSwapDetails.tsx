        ...
        <RowBetween align="flex-start">
          <RowFixed>
            ...
            <QuestionHelper
              text={
                <>
                  <Text>{t('Fees saved on NbcSwap compared to major DEXs charging interface fees')}</Text>
                </>
              }
              ml="4px"
              placement="top"
              ...
              text={
                <>
                  ...
                  <Text mt="10px">
                    ...
                    :{' '}
                    {t(
                      'NbcSwap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% - 0.25% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.',
                    )}
                  </Text>
                </>
              }
