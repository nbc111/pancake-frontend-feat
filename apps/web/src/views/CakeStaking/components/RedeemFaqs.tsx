    ...
    description: (
      <>
        <ul>
          ...
          <li>
            <Trans>
              NbcSwap cannot process redemptions for externally managed veCAKE — please check directly with those
              platforms.
            </Trans>
          </li>
        </ul>
    ...
    description: (
      <>
        <ul>
          ...
          <li>
            <Trans>
              The NbcSwap UI will gradually reflect the retirement of affected products from these changes.
            </Trans>
          </li>
        </ul>
      </>
