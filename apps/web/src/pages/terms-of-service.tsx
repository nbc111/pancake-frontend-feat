...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">NbcSwap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        NbcSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. NbcSwap does not control or operate any version of the Protocol on any blockchain
        ...
        NbcSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        NbcSwap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the NbcSwap default token list and
        NbcSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
