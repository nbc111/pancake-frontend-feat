...
const whitelist = [
  ...
  'Latest News about NbcSwap and more!',
  'Gaming Announcements',
  'NbcSwap Gaming Community',
  'Gaming Community',
  ...
  'NbcSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
