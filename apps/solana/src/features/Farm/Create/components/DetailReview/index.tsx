      ...
      <Flex direction="column" w="full" gap={6}>
        ...
        <Box fontSize="sm" fontWeight={500}>
          ...
          <Text color={colors.textSubtle} display="inline">
            {t(
              'Rewards allocated to farms cannot be withdrawn after farming starts. Newly created farms generally appear on NbcSwap 10-30 minutes after creation, depending on Solana network status.'
            )}
          </Text>
        </Box>
