...
export function PriorityModalContent(props: {
  ...
  return (
    <ModalV2 isOpen={props.isOpen} onDismiss={props.onClose} closeOnOverlayClick>
      ...
      >
        <VStack gap={4}>
          <Text fontSize="14px">{t('Fee settings are applied across all NbcSwap features, including Swap, Liquidity.')}</Text>
          <Divider />
          ...
          <VStack width="full" align="stretch" gap={3}>
            ...
            <Text fontSize="14px" color="textSubtle">
              {priorityMode === 0
                ? t('NbcSwap auto-optimizes priority fees for your transaction. Set a max cap to prevent overpaying.')
