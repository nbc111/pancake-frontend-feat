        ...
        <Box>
          <Text display="inline" color="currentColor">
            ...
            <p>
              ...
              <br />
              <br />
              {t("Claim your Farm rewards on NbcSwap and your Merkl rewards on")}
            ...
            <br />
            <br />
            {t("To earn Farm rewards, continue seeding liquidity on NbcSwap and stake your LP token in the Farm.")}
          </Text>
        </Box>
      </>
    );
